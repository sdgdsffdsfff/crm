...
<table width="98%" height="126" border="0" cellpadding="3" cellspacing="1" bgcolor="#cccccc" style="margin:0 auto;padding-top:10px;">
  <form name="myform" action="customer_area_ok.php?act=add" method="post" onSubmit="return checkreg();">
    ...
    <tr>
      <td width="13%" height="24" align="right" valign="middle" bgcolor="#f1f1f1">上级状态：</td>
      <td width="87%" height="24" align="left" valign="middle" bgcolor="#f1f1f1"><select name="fid">
          <option value="0">--顶级状态--</option>
...
<?php
if($act == "mod"){
	$sql = get_sql("select id,name,fid,rank from {pre}industry where id=".$id);
	$list = $db->getonerow($sql);
?>
<table width="98%" height="126" border="0" cellpadding="3" cellspacing="1" bgcolor="#cccccc" style="margin:0 auto;padding-top:10px;">
  <form name="myform" action="customer_industry_ok.php?act=mod" method="post" onSubmit="return checkreg();">
    <tr>
      <td height="24" colspan="2" bgcolor="#555555"><font color="#FFFFFF">&nbsp;<strong>修改状态</strong></font></td>
    </tr>
    <tr>
      <td width="13%" height="24" align="right" valign="middle" bgcolor="#f1f1f1">上级状态：</td>
      <td width="87%" height="24" align="left" valign="middle" bgcolor="#f1f1f1"><select name="fid">

...
<table width="98%" height="126" border="0" cellpadding="3" cellspacing="1" bgcolor="#cccccc" style="margin:0 auto;padding-top:10px;">
  <form name="myform" action="customer_services_ok.php?act=add" method="post" onSubmit="return checkreg();">
    <tr>
      <td height="24" colspan="2" bgcolor="#555555"><font color="#FFFFFF">&nbsp;<strong>添加服务</strong></font></td>
    </tr>
    <tr>
      ...
      <td width="87%" height="24" align="left" valign="middle" bgcolor="#f1f1f1"><select name="fid">
        <option value="0">--顶级类别--</option>
          <?php getCategorySelect("services",$fid); ?>
        </select>      </td>
    </tr>
    <tr>
      <td width="13%" height="24" align="right" valign="middle" bgcolor="#f1f1f1">服务名称：</td>
...
<table width="98%" height="94" border="0" cellpadding="3" cellspacing="1" bgcolor="#cccccc" style="margin:0 auto;padding-top:10px;">
  <tr bgcolor="#666666">
    <td height="22" colspan="4" bgcolor="#555555"><font color="#FFFFFF">&nbsp;<strong>服务管理</strong></font></td>
  </tr>
  <tr bgcolor="#f9f9f9">
    <td width="5%" height="24" align="center" valign="middle">ID</td>
    <td width="30%" height="24" align="center" valign="middle">服务名称</td>
    <td align="center" valign="middle">上级类别</td>
    <td width="25%" height="24" align="center" valign="middle">操作</td>
  </tr>
  <?php
  	foreach($area_list as $list){
		$fid_name = get_table_row("services",$list['fid'],"name");
		$fid_name = empty($fid_name) ? "顶级类别" : $fid_name;
  ?>
  <tr bgcolor="#f9f9f9">
    <td width="5%" height="24" align="center" valign="middle"><?php echo $list['id'];?></td>
    <td width="30%" height="24" align="center" valign="middle"><a href="customer_services_action.php?act=mod&id=<?php echo $list['id'];?>&fid=<?php echo $list['fid'];?>"><?php echo $list['name'];?></a></td>
    <td align="center" valign="middle"><?php echo $fid_name;?></td>
    <td width="25%" height="24" align="center" valign="middle"><a href="customer_services_action.php?act=mod&id=<?php echo $list['id']; ?>&page=<?php echo $page;?>"><img src="../images/edit.gif" border="0" /></a> <a href="customer_services_ok.php?id=<?php echo $list['id']; ?>&act=del" onClick="javascript:return confirm('确实要删除吗?')"><img src="../images/del.gif" border="0" /></a></td>
  </tr>
  <?php
	}
  ?>
  <tr>
    <td height="24" colspan="4" bgcolor="#F8FCF6"><?php page($sqlstr,$page_size,"customer_services.php?page",$page);?></td>
  </tr>
</table>
</body>
</html>
